...
Welcome to the Mobile Wallet application! This project is designed to provide users with a seamless experience for managing their digital assets using blockchain technology.
...
- User authentication via Moralis
...
- **Moralis**: A powerful platform for decentralized applications that provides authentication and database services.
...
- [Expo CLI](https://docs.expo.dev/get-started/installation/) (for easier development with React Native)
...
- npm install
- expo start
- Follow the instructions in the terminal to run the app on an Android or iOS emulator or your physical device.
